    ...
    <div class="box-content">
        ...
        <form class="form-horizontal" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-sm-4">¿Con qué te identificas más?</label>
                                <div class="col-sm-7">
                                    <select class="form-control" name="val[tipoClass]">
                                        <option {{($user->tipoClass == 'Gamer') ? 'selected' : null}} value="Gamer">Gamer</option>
                                        <option {{($user->tipoClass == 'Otaku') ? 'selected' : null}} value="Otaku">Otaku</option>
                                        <option {{($user->tipoClass == 'Cinéfilo') ? 'selected' : null}} value="Cinéfilo">Cinéfilo</option>
                                        <option {{($user->tipoClass == 'Seriéfilo') ? 'selected' : null}} value="Seriéfilo">Seriéfilo</option>
                                        <option {{($user->tipoClass == 'Bibliófilo') ? 'selected' : null}} value="Bibliófilo">Bibliófilo</option>
                                    </select>
                                </div>
                            </div>
