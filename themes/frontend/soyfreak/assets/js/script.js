...
/**
    ...
    function reloadPlugins(update) {
        ...
        /**qtip titles**/
        $('.navbar-barra li').each(function() {
            $(this).children("[title!='']").qtip({
                position : {
                    my : 'center left',
                    at : 'center right'
                },
...
$(function() {
    ...
    $(document).on('click', '.editor-header li a', function(){
        if($(this).hasClass('current')){
            $('.editor-body').toggle('fast');
            $('.editor-footer').toggle('fast');
        }else {
            $('.editor-body').show('fast');
