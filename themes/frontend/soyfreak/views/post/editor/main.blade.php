    ...
    <form enctype="multipart/form-data" id="post-form" class="form-horizontal"  action="" method="post">
        ...
        <div class="editor-header">
            <ul class="nav clearfix">
                <li><a class="status" href=""> <i class="icon ion-edit"></i> {{trans('post.status')}}</a> </li>
        ...
        <div class="editor-body">
            <div class="media post-textarea-container">
                ...
                <button id="post-submit-button" class="btn btn-sm btn-success"><i class="icon ion-paper-airplane"></i></button>
            </div>
