<div class="post-header clearfix">
            ...
            <div class="header-body">
                ...
                <div class="post-action-dropdown dropdown">
                    <a  data-hover="dropdown" data-toggle="dropdown" class="dropdown-toggle" href=""><i class="icon ion-chevron-down"></i></a>
                   ...
                   @if (Auth::check())
                         ...
                         <ul class="dropdown-menu pull-right">
                            ...
                            @if (Auth::user()->id != $post->user->id)
                                <li><a data-location="post" data-userid="{{$post->user->id}}" class="block-user" href="">Block user</a> </li>
                            @endif

                            <li><a href="{{URL::route('report', ['type' => 'post'])}}?url={{$post->present()->url()}}">Report post</a> </li>
                            ...
                            @if ($post->present()->canDelete() or $post->community->present()->canManage())
                                ...
                                <li><a data-id="{{$post->id}}" class="delete-post" data-message="Do you really want to delete this post" href="">Remove</a> </li>
                            @endif
