<div class="box">
    ...
    <div class="box-content" style="padding: 0 50px">
        @if($message)
        ...
        <form action="" method="post">
            ...
            <div class="form-group">
                ...
                <textarea style="height: 300px  " class="editor" name="val[post]" placeholder="{{trans('blog::global.post')}}">{{$blog->content}}</textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <a class="btn btn-danger" href="{{$blog->url('delete')}}">{{trans('blog::global.delete')}}</a>
            </div>
        </form>
    </div>
</div>