    ...
    <div class="box-content">
        ...
        <form class="form-horizontal" action="" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <select class="form-control" name="val[type]">
                        <option {{($field->type == 'user-form') ? 'selected' : null}} value="user-form">User</option>
                        <option {{($field->type == 'page-form') ? 'selected' : null}} value="user-form" >Page</option>
            ...
            <div class="body-header">
                <input class="btn btn-danger no-radius" type="submit" value="Save Field"/>
            </div>
